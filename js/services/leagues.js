...
const SPORT_LEAGUES = [
  ...
  SOC('eng.1', 'Premier League'), SOC('uefa.champions', 'Champions League'), SOC('uefa.europa', 'Europa League'), SOC('uefa.europa.conf', 'Conference League'),
  SOC('esp.1', 'La Liga'), SOC('ita.1', 'Serie A'), SOC('ger.1', 'Bundesliga'), SOC('fra.1', 'Ligue 1'), SOC('ned.1', 'Eredivisie'), SOC('por.1', 'Primeira Liga'),
  ...
  SOC('cze.1', 'Czech First League'), SOC('pol.1', 'Ekstraklasa'), SOC('rou.1', 'Romanian Liga I'), SOC('ukr.1', 'Ukrainian Premier League'), SOC('cro.1', 'Croatian HNL'),
  ...
  SOC('fin.1', 'Veikkausliiga'), SOC('irl.1', 'League of Ireland'), SOC('wal.1', 'Cymru Premier'), SOC('nir.1', 'NIFL Premiership'), SOC('svk.1', 'Slovak Super Liga'),
  ...
  SOC('ger.dfb_pokal', 'DFB-Pokal'), SOC('fra.coupe_de_france', 'Coupe de France'), SOC('ned.cup', 'KNVB Cup'), SOC('por.taca.portugal', 'Taça de Portugal'), SOC('sco.tennents', 'Scottish Cup'),
